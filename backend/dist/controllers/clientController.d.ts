...
export declare const createAppointmentHandler: (req: Request, res: Response) => Response<any, Record<string, any>> | undefined;
...
export declare const updateAppointmentHandler: (req: Request, res: Response) => Response<any, Record<string, any>> | undefined;
export declare const deleteAppointmentHandler: (req: Request, res: Response) => Response<any, Record<string, any>> | undefined;
