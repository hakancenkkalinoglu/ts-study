...
public class SchemaMigrator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        jdbc.update("DELETE FROM clinic_invitations WHERE expiresAt < ?", System.currentTimeMillis());
    }
    ...
    private void createTables() {
        ...
        jdbc.execute(
                """
                CREATE TABLE IF NOT EXISTS clinic_share_payments (
                  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                  clinicId BIGINT NOT NULL,
                  userId BIGINT NOT NULL,
    ...
    private void createIndexes() {
        List<String> indexes = List.of(
                ...
                "CREATE INDEX IF NOT EXISTS ix_commission_rates_lookup ON commission_rates(clinicId, userId, validFrom)",
                "CREATE INDEX IF NOT EXISTS ix_share_payments_lookup ON clinic_share_payments(clinicId, userId, period)",
