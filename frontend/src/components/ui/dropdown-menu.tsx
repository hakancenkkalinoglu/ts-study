  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'z-50 min-w-44 overflow-hidden rounded-lg border border-solid bg-popover p-1 text-popover-foreground shadow-lg',
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        'focus:bg-accent data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:text-muted-foreground',
